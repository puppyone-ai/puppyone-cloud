-- ============================================================================
-- Root-first scoped publish.
--
-- The project root is the canonical source of truth. Scoped access writes
-- publish by CAS-ing projects.mut_root_hash, while mut_scope_state rows are
-- updated in the same transaction as derived caches for Git/AP views.
-- ============================================================================
