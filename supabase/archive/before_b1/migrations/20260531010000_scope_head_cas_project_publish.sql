-- ============================================================================
-- Require source-scope head CAS inside the root-first publish transaction.
--
-- Root hash CAS protects the canonical project tree. Scoped Git/AP views also
-- need an atomic expected-head guard so a stale client SHA cannot overwrite a
-- scope row whose head moved after L5 read it.
-- ============================================================================
